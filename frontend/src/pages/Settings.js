  ...
  const handleExportData = async (format) => {
    try {
      ...
      if (format === "json") {
        ...
        link.href = url;
        link.download = `crm_export_${company.name}_${
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="p-6 max-w-4xl">
          ...
          {user?.role === "superadmin" && (
            <div className="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-6 mt-6 mb-6">
            ...
            {unregisterStep === "confirm" ? (
              <div className="p-6">
                ...
                <div className="bg-red-50 border border-red-300 rounded-lg p-4 mb-6">
                  ...
                  <ul className="text-sm text-red-900 mt-2 ml-4 space-y-1">
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    placeholder="000000"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500 text-center text-xl tracking-widest"
                  />
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={unregisterLoading || otp.length !== 6}
                    className="flex-1 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {unregisterLoading
                      ? "Processing..."
